const GitcoinCurriculumData = [
  ...
  {
    id: 4,
    title: 'It is all about coordination',
    description:
      "It's all coordination, and it always has been.  Human beings compete for resources, but we also coordinate to survive.  We are interpedentant beings, depending on families, companies, DAOs, and markets to survive.  How can we accelerate coordination in the ecosystem to solve coordination failures in the world faster?  In this talk, Austin Griffith and Kevin Owocki will give their takes + announce a coordination tool to help us coordinate better at scale, and solve coordination failures in the world.  It's all coordination, and it always has been.",
    contentType: 'video',
    time: 1000,
