...
Decentralized learning platforms allow learners to engage with a community in order to learn new skills and perspectives. This allows for a a many-to-many learning flow to occur. Many of these learning communities have been established organically, created by the community to fill a particular need. The rules, roles, rewards and content format is often unclear as the community works to define it's standard work processes.
